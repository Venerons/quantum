...
(function () {
	...
	var QuantumUtils = Object.create(null);

	QuantumUtils.log = function () {
		try {
	...
	QuantumUtils.error = function (error, message) {
		QuantumUtils.log(
			'error',
			(message ? message : '') +
			'\n\n' +
	...
	QuantumUtils.require = function (settings) {
	...
	window.Quantum.utils = QuantumUtils;
})();
